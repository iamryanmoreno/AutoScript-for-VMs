...
ECHO       sudo bash virtnet/bin/vn-deploynode 3 1
ECHO    4. Repeat steps 1, 2 and 3 for node2, but with command:
ECHO       sudo bash virtnet/bin/vn-deploynode 3 2
ECHO    5. Repeat steps 1, 2 and 3 for node3, but with command:
ECHO       sudo bash virtnet/bin/vn-deploynode 3 3
